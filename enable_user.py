#!/usr/bin/env python
#
#title           :enable_user.py
#description     :This is a sample script to demonstrate how to enable a disabled user from the Smart Communications API.
#author          :Michael Dodwell <michael@dodwell.us>
#date            :20161129
#version         :0.1
#usage           :python enable_user.py
#notes           :See https://example.thunderhead.com/one/help/api/index.htm#22469.htm
...
# Make a small array showing the user and how we want to disable them
user = {}
user['userId'] = 'michael.d.dodwell2@accenture.com.trial'
user['active'] = 'true'
...
print 'User '+ user['userId'] .' disabled.'
